{
  ...
  Glenzvector cube with z light source demo. Drawn with quads.
...
begin
  ...
  repeat
    ...
    for loop1:=maxpolygons-maxvisible to maxpolygons do begin
      draw_4_glenz(xp[polygons[pind[loop1],1]],yp[polygons[pind[loop1],1]],
                   xp[polygons[pind[loop1],2]],yp[polygons[pind[loop1],2]],
                   xp[polygons[pind[loop1],3]],yp[polygons[pind[loop1],3]],
                   xp[polygons[pind[loop1],4]],yp[polygons[pind[loop1],4]],polyz[loop1]+30);
    end;
